...
class WeatherModel {
  ...
  @override
  String toString() {
    return 'weatherModel{date $date ,weatherStateName: $weatherStateName ,temp $temp ,maxTemp $maxTemp ,minTemp $minTemp}';
  }
  String getImage() {
    ...
    } else if (weatherStateName == 'Thundery outbreaks possible' || weatherStateName == 'Moderate or heavy snow with thunder' || weatherStateName == 'Patchy light snow with thunder'|| weatherStateName == 'Thunder'|| weatherStateName == 'Moderate or heavy rain with thunder' || weatherStateName == 'Patchy light rain with thunder' ) {
